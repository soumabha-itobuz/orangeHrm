...
const locators = {
  ...
  addEntitlementOption: ".oxd-dropdown-menu > li:nth-child(1)",
...
test.describe("Leave / Entitlement", () => {
  ...
  test("Add Leave Entitlement", async () => {
    ...
    await page.click(locators.addEntitlementOption);
    await page.locator(locators.employeeNameInput).fill("Timothy Lewis Amiano");
    await page.click(locators.leaveType);
    await page.click(locators.leaveTypeOptions);
    await page.locator(locators.entitlementField).fill("2");
